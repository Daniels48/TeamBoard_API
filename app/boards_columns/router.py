...
from app.boards_columns.schema import BoardColumnResponse, BoardColumnCreate
from app.boards_columns.service import BoardColumnService
...
async def create_column(
    ...
    return await BoardColumnService.create_column(
        db=db,
...
async def get_columns(
    ...
    return await BoardColumnService.get_columns(
        db=db,
        board_public_id=board_id,
        user=user,
    )